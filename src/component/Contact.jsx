        ...
        <div name="contact" className="w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white">
            <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
                ...
                <div  className="flex justify-center items-center">
                    <form action="https://getform.io/f/nadevrpb" method="POST" className="flex flex-col w-full md:w-1/2">
                        ...
                        <button className="text-white bg-gradient-to-b from-cyan-500 to-blue-500 mt-3 px-6 py-3 mx-auto flex items-center rounded-md hover:scale-110 duration-300">Submit</button>
                    </form>
                </div>
            </div>
        </div>
